...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter__ = __webpack_require__(642);
...
var FilterPage = /** @class */ (function () {
    function FilterPage(navCtrl, viewCtrl, navParams, api, service) {
    ...
    FilterPage.prototype.ionViewDidLoad = function () {
        ...
        base.api.GET("/getAttributesByUrl/" + base.catUrl).then(function (Items) {
    ...
    FilterPage.prototype.selectedsegment = function (info) {
        console.log(info);
        this.filtermodel = info.name;
    };
    FilterPage.prototype.selectedCheckbox = function (info, val) {
        // console.log(info);
        // console.log(val);
        var temparr = [];
        temparr.push({
        ...
        console.log(temparr);
        var exists = __WEBPACK_IMPORTED_MODULE_4_underscore__["filter"](this.selectedVal, function (elem) {
    ...
    FilterPage.prototype.getChecked = function (val) {
        var selected = JSON.parse(localStorage.getItem('choosen'));
        var exist = __WEBPACK_IMPORTED_MODULE_4_underscore__["filter"](selected, function (elem) {
            if (elem.value == val) {
                return elem;
            }
        });
