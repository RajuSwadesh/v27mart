...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__classified_add__ = __webpack_require__(679);
...
var ClassifiedAddPageModule = /** @class */ (function () {
    function ClassifiedAddPageModule() {
    }
    ClassifiedAddPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__classified_add__["a" /* ClassifiedAddPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__classified_add__["a" /* ClassifiedAddPage */]),
            ],
        })
...
//# sourceMappingURL=classified-add.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClassifiedAddPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_image_picker__ = __webpack_require__(617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_underscore__ = __webpack_require__(615);
...
var ClassifiedAddPage = /** @class */ (function () {
    function ClassifiedAddPage(navCtrl, navParams, api, service, camera, actionSheetController, imagePicker) {
    ...
    ClassifiedAddPage.prototype.ionViewDidLoad = function () {
        var _this = this;
    ...
    ClassifiedAddPage.prototype.initautocomplete = function () {
        var base = this;
        setTimeout(function () {
            console.log('--------------------------------------------------------------------------------');
    ...
    ClassifiedAddPage.prototype.chooseImage = function () {
        var _this = this;
        var base = this;
        var options = {
            quality: 20,
    ...
    ClassifiedAddPage.prototype.remove = function (index) {
        this.donation_images.splice(index, 1);
        this.donation_img_length = this.donation_img_length + (+1);
    };
    ClassifiedAddPage.prototype.chooseMultipleImage = function () {
        var _this = this;
        var base = this;
        var options = {
            quality: 20,
        ...
        base.imagePicker.getPictures(options).then(function (results) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                console.log(_this.multiple_donation_images);
            }
    ...
    ClassifiedAddPage.prototype.removeImages = function (index) {
    ...
    //   });
    // }
    ClassifiedAddPage.prototype.donatepayment = function () {
        this.navCtrl.push('DonatepaymentPage');
    };
    ClassifiedAddPage.prototype.donate = function () {
        var _this = this;
        this.formData = [];
        if (this.category == '') {
            ...
            if (this.sub_category == '') {
                ...
                for (var i = 0; i < this.subCatField.length; i++) {
                    ...
                    if (this.subCatField[i].field_type == "Text") {
                        console.log(this.textField);
                        console.log(document.getElementById(this.subCatField[i].name).value);
                        this.textField = document.getElementById(this.subCatField[i].name).value;
                        console.log(this.textField);
                        if (this.textField == '') {
                        ...
                        console.log(document.getElementById(this.subCatField[i].name).value);
                        this.numberField = document.getElementById(this.subCatField[i].name).value;
                        if (this.numberField == '') {
                            this.service.Warning(this.subCatField[i].name + " is required!!");
                            // this.service.LoaderHide();
                        }
                        ...
                        console.log(this.subCatField[i].name);
                        console.log(document.getElementById(this.subCatField[i].name).value);
                        this.dateField = document.getElementById(this.subCatField[i].name).value;
                        if (this.dateField == '') {
                            this.service.Warning(this.subCatField[i].name + " is required!!");
                            // this.service.LoaderHide();
                        }
                        ...
                        console.log(this.subCatField[i].name);
                        console.log(document.getElementById(this.subCatField[i].name).value);
                        this.textareaField = document.getElementById(this.subCatField[i].name).value;
                ...
                if (this.textField != '' && this.numberField != '' && this.dateField != '' && this.textareaField != '' && this.checkedvalue != '') {
                    ...
                    if (this.category != undefined && this.sub_category != undefined) {
                        ...
                        this.api.POST('/saveClassified', { in_category: this.pro_cat, data: this.formData, address: this.FormLocation.address, latitude: this.FormLocation.latitude,
                            longitude: this.FormLocation.longitude }).then(function (res) {
                            console.log(res);
                            if (res.status == "success") {
                                console.log(res);
                                _this.formData = [];
                                _this.service.Success(res.data);
                                _this.navCtrl.push('MyClassifiedPage');
                            ...
                            console.log(error);
                            _this.service.Warning("Something went wrong!!!");
                            _this.service.LoaderShow();
                        };
                    }
                    else {
                        this.service.LoaderShowmsg("Saving product..");
    ...
    // }
    ClassifiedAddPage.prototype.getCheck = function (arr, data) {
        console.log("check");
    ...
    ClassifiedAddPage.prototype.getGender = function (data2) {
        console.log(data2.fld);
        this.radioField = data2.fld;
    };
    ClassifiedAddPage.prototype.donate2 = function () {
        if (this.category == '') {
            this.service.Warning('Please choose category');
        }
        else if (this.sub_cat_section.length > 0) {
    ...
    ClassifiedAddPage.prototype.save = function () {
        var _this = this;
    ...
    ClassifiedAddPage.prototype.selectedVal = function (info) {
        var _this = this;
        this.pro_cat = this.category;
        var filtered_data = __WEBPACK_IMPORTED_MODULE_6_underscore__["filter"](this.category_list, function (elem) {
    ...
    ClassifiedAddPage.prototype.selectedVal1 = function () {
        var _this = this;
        console.log(this.sub_category);
        this.pro_cat = this.category + ',' + this.sub_category;
        console.log(this.pro_cat);
        this.api.GET('/getClassifiedFields/' + this.sub_category).then(function (res) {
            console.log(res);
            var arr1 = [];
            if (res.status == "success") {
                console.log(res.data);
                _this.subCatField = [];
                _this.subCatField = res.data;
                for (var i = 0; i < _this.subCatField.length; i++) {
                    var labelName = _this.subCatField[i].name.toLowerCase();
                    //  console.log(labelName.replace(/\s/g,''));
                    _this.subCatField[i].ngmodel = labelName.replace(/\s/g, '');
                    console.log(_this.subCatField[i]);
                    if (_this.subCatField[i].field_type == "Checkbox") {
                        console.log(_this.subCatField[i].field_values);
                        var array = _this.subCatField[i].field_values.split(',');
                        _this.subCatField[i].arrayField = array;
                        console.log(array);
                        // this.subCatField[i].field_type.push(array);
                        console.log(_this.subCatField[i].arrayField);
                    }
                    else if (_this.subCatField[i].field_type == "Radio") {
                        console.log(_this.subCatField[i].field_values);
                        var arrValues = _this.subCatField[i].field_values.split(',');
                        ...
                        _this.subCatField[i].radioField = arr1;
                        console.log(_this.subCatField[i].radioField.length);
                    }
                }
                // console.log(this.subCatField);
            }
    ...
    ClassifiedAddPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-classified-add',template:/*ion-inline-start:"E:\SWADESH\Marketplace\src\pages\classified-add\classified-add.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Add Classified Product</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <!-- <ul>\n    <li><img src="assets/imgs/donation-9.jpg"></li>\n    <li><img src="assets/imgs/donation-10.jpg"></li>\n    <li><img src="assets/imgs/donation-11.jpg"></li>\n  </ul> -->\n\n  <ion-list>\n    <ion-item>\n      <ion-label floating>Category</ion-label>\n      <ion-select [(ngModel)]="category" (ionChange)="selectedVal(item)">\n        <ion-option *ngFor="let item of category_list" value="{{item.id}}" >{{item.name}}</ion-option>\n      </ion-select>\n    </ion-item>\n\n    <ion-item *ngIf="category && sub_cat_section.length>0">\n      <ion-label floating>Sub Category</ion-label>\n      <ion-select [(ngModel)]="sub_category" (ionChange)="selectedVal1()">\n        <ion-option *ngFor="let item of sub_cat_section" value="{{item.id}}" >{{item.name}}</ion-option>\n      </ion-select>\n    </ion-item>\n\n    <div class="custom" *ngFor="let subfield of subCatField;let i=index">\n      <div class="subcustom"  *ngIf="subfield.field_type == \'Text\'">\n       <label>{{subfield.label}}</label>\n       <input type="{{subfield.field_type}}" name="{{subfield.name}}" id="{{subfield.name}}"  placeholder="name....">\n      </div>\n\n      <div *ngIf="subfield.field_type == \'Checkbox\'" class="input_fields">\n        <b>{{subfield.label}}</b>\n        <!-- <div class="subcustom"  *ngIf="subfield.field_type == \'Text\'"> -->\n           <div class="item" *ngFor="let arr of subfield.arrayField;let i=index" (click)="getCheck(arr)">\n             <label> <span>{{arr}}</span>\n             <input class="mycheck" type="checkbox" name="{{subfield.name}}" id="{{subfield.name}}" [value]="arr">\n            </label>\n           </div>\n        <!-- </div> -->\n      </div>\n\n      <div *ngIf="subfield.field_type == \'Radio\'" class="input_fields">\n        <b>{{subfield.label}}</b>\n           <div class="item" *ngFor="let arr of subfield.radioField;" (change)="getGender(arr)">\n             <label> <span>{{arr.fld}}</span>\n             <input type="radio" name="{{subfield.name}}" id="{{subfield.name}}" [value]="arr.fld">\n            </label>\n           </div>\n      </div>\n\n      <div class="subcustom"  *ngIf="subfield.field_type == \'Number\'">\n        <label>{{subfield.label}}</label>\n        <input type="{{subfield.field_type}}" name="{{subfield.name}}" id="{{subfield.name}}"  placeholder="experince....">\n       </div>\n\n       <div class="subcustom"  *ngIf="subfield.field_type == \'Date\'">\n        <label>{{subfield.label}}</label>\n        <input type="{{subfield.field_type}}" name="{{subfield.name}}" id="{{subfield.name}}"  placeholder="Date....">\n       </div>\n\n       <div class="subcustom"  *ngIf="subfield.field_type == \'Textarea\'">\n        <label>{{subfield.label}}</label>\n        <input type="{{subfield.field_type}}" name="{{subfield.name}}" id="{{subfield.name}}"  placeholder="about....">\n       </div>\n      \n      <!-- <ion-item *ngIf="subfield.field_type == \'Text\'">\n        <ion-label floating>{{subfield.label}}</ion-label>\n        <ion-input type="{{subfield.field_type}}" id="{{subfield.name}}" class="my-input" ></ion-input>\n      </ion-item>\n\n      <div *ngIf="subfield.field_type == \'Checkbox\'">\n        <ion-label>{{subfield.label}}</ion-label>\n         <ion-list style="margin: 0px auto;">\n        <ion-item *ngFor="let arr of subfield.arrayField;let i=index">\n        <ion-label>{{arr}}</ion-label>\n        <ion-checkbox id="{{subfield.name}}"></ion-checkbox>\n        </ion-item>\n        </ion-list>\n      </div> -->\n\n      <!-- <div *ngIf="subfield.field_type == \'Radio\'">\n        <ion-label>{{subfield.label}}</ion-label>\n        <ion-list radio-group (ngModel)="[subfield.name]" id="{{subfield.name}}" style="margin: 0px auto;">\n         <ion-item *ngFor="let arr of subfield.radioField">\n         <ion-label>{{arr.fld}}</ion-label>\n          <ion-radio [value]="arr.fld"></ion-radio>\n        </ion-item>\n      </ion-list>\n      </div> -->\n\n      \n\n      <!-- <ion-item *ngIf="subfield.field_type == \'Number\'">\n        <ion-label floating>{{subfield.label}}</ion-label>\n        <ion-input type="{{subfield.field_type}}" id="{{subfield.name}}" class="my-input" placeholder="Experince..."></ion-input>\n      </ion-item> -->\n\n      <!-- <ion-item *ngIf="subfield.field_type == \'Date\'">\n        <ion-label floating>{{subfield.label}}</ion-label>\n        <ion-input clearInput  type="{{subfield.field_type}}" id="{{subfield.name}}" class="my-input" placeholder="date..."></ion-input>\n      </ion-item> -->\n\n      <!-- <ion-item *ngIf="subfield.field_type == \'Textarea\'">\n        <ion-label floating>{{subfield.label}}</ion-label>\n        <ion-textarea id="{{subfield.name}}" class="my-input" placeholder="About You..."></ion-textarea>\n      </ion-item> -->\n      \n\n      <ion-item no-lines *ngIf="subfield.field_type == \'Single_image\'">\n        <span item-start>Choose Images <span style="color:grey;font-size:13px;"></span></span><span item-end class="cam" (click)="chooseImage()" *ngIf="donation_img_length>0"><ion-icon name="camera"></ion-icon></span><br/>\n        <!-- <span item-start>Choose Images <span style="color:grey;font-size:13px;">(Maximum 6 Images)</span></span><span item-end class="cam" (click)="chooseMultipleImage()" *ngIf="donation_img_length>0"><ion-icon name="camera"></ion-icon></span> -->\n      </ion-item>\n\n      <ion-item no-lines *ngIf="subfield.field_type == \'Multiple_image\'">\n        <!-- <span item-start>Choose Images <span style="color:grey;font-size:13px;">(Maximum 6 Images)</span></span><span item-end class="cam" (click)="chooseMultipleImage()" *ngIf="donation_img_length>0"><ion-icon name="camera"></ion-icon></span> -->\n      </ion-item>\n\n      \n    </div>\n\n      <!-- <ion-item no-lines> \n       <span item-start>Choose Images <span style="color:grey;font-size:13px;"></span></span><span item-end class="cam" (click)="chooseMultipleImage()" *ngIf="donation_img_length>0"><ion-icon name="camera"></ion-icon></span>\n     </ion-item> -->\n     <!------------------------------ Single Image -------------------------------->\n    <ion-row>\n      <ion-col col-4 *ngFor="let item of donation_images;let i=index">\n        <div class="container">\n          <img [src]="item"/>\n          <div class="top-right" (click)="remove(i)"><ion-icon name="close"></ion-icon></div>\n        </div>\n      </ion-col>\n    </ion-row>\n    <!------------------------------ Multiple Image -------------------------------->\n    <ion-row>\n      <ion-col col-4 *ngFor="let item2 of multiple_donation_images;let i=index">\n        <div class="container">\n          <img [src]="item2"/>\n          <div class="top-right" (click)="removeImages(i)"><ion-icon name="close"></ion-icon></div>\n        </div>\n      </ion-col>\n    </ion-row>\n\n\n    <div class="custom" style="margin-top:17px;" *ngIf="sub_cat_section.length>0">\n    <div class="subcustom" >\n    <label>Enter address</label>\n    <input type="text" id="GoForm"  placeholder="enter address...." [(ngModel)]="FormLocation.address">\n    </div>\n    </div>\n \n      <!-- <ion-list *ngFor="let subfield of subCatField">   \n      <ion-item *ngIf="subfield.field_type == \'Text\'">\n      <ion-label floating>{{subfield.label}}</ion-label>\n      <ion-input type="{{subfield.field_type}}" [(ngModel)]="product_title" class="my-input"></ion-input>\n    </ion-item>\n    <ion-item *ngIf="subfield.field_type == \'Radio\'">\n      <ion-label floating>{{subfield.label}}</ion-label>\n      <ion-radio  value="male"></ion-radio>\n    </ion-item>\n  </ion-list> -->\n  \n<!-- <div *ngIf="sub_cat_section.length == 0">\n    <ion-item>\n      <ion-label floating>Product Title</ion-label>\n      <ion-input type="text" [(ngModel)]="product_title" class="my-input"></ion-input>\n    </ion-item>\n\n    <ion-item>\n      <ion-label floating>Description</ion-label>\n      <ion-textarea type="text" [(ngModel)]="description" class="my-input"></ion-textarea>\n    </ion-item>\n\n    <ion-item>\n      <ion-label floating>Stock (optional)</ion-label>\n      <ion-input type="number" [(ngModel)]="stock" class="my-input"></ion-input>\n    </ion-item>\n\n    <ion-item>\n      <ion-label floating>Product Condition (Optional)</ion-label>\n      <ion-select [(ngModel)]="product_condition">\n        <ion-option value="new">New</ion-option>\n        <ion-option value="used">Used</ion-option>\n        <ion-option value="damaged">Damaged</ion-option>\n      </ion-select>\n    </ion-item>\n\n\n    <ion-item>\n      <ion-label floating>Price</ion-label>\n      <ion-input type="tel" [(ngModel)]="price" class="my-input"></ion-input>\n    </ion-item>\n\n    <ion-item no-lines>\n      <span item-start>Choose Images <span style="color:grey;font-size:13px;">(Maximum 6 Images)</span></span><span item-end class="cam" (click)="chooseImage()" *ngIf="donation_img_length>0"><ion-icon name="camera"></ion-icon></span>\n    </ion-item>\n  </div> -->\n\n    <button ion-button color="primary" full class="animated fadeInLeft" style="animation-delay: 0.6s" (tap)="donate()" id="clickme">Submit</button>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"E:\SWADESH\Marketplace\src\pages\classified-add\classified-add.html"*/,
            providers: [
...
//# sourceMappingURL=classified-add.js.map
